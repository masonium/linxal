...
pub trait SymmetricSolveLinear: Sized + Clone {
    ...
    fn compute_multi_into<D1, D2>(a: ArrayBase<D1, Ix2>, uplo: Symmetric, b: ArrayBase<D2, Ix2>) ->
    ...
    fn compute_into<D1, D2>(a: ArrayBase<D1, Ix2>, uplo: Symmetric, b: ArrayBase<D2, Ix>) ->
    ...
    /// Solve the linear system A * x = B for symmetric/hermitian square matrix `a` and rectangular matrix `b`.
    fn compute_multi<D1, D2>(a: &ArrayBase<D1, Ix2>, uplo: Symmetric, b: &ArrayBase<D2, Ix2>) -> Result<Array<Self, Ix2>, SolveError>
    ...
    /// Solve the linear system A * x = b for symmetric/hermitian square matrix `a` and column vector `b`.
    fn compute<D1, D2>(a: &ArrayBase<D1, Ix2>, uplo: Symmetric, b: &ArrayBase<D2, Ix>) -> Result<Array<Self, Ix>, SolveError>
        where D1: Data<Elem=Self>, D2: Data<Elem=Self> {
...
macro_rules! impl_solve_linear {
    ($impl_type: ty, $driver: ident) => (
        impl SymmetricSolveLinear for $impl_type {
            fn compute_multi_into<D1, D2>(mut a: ArrayBase<D1, Ix2>, uplo: Symmetric, mut b: ArrayBase<D2, Ix2>) ->
                Result<ArrayBase<D2, Ix2>, SolveError>
